					...
					<div className="flex-1 overflow-y-auto space-y-4">
										...
										<div
											...
											<div className="flex-1 min-w-0">
												<div className="flex items-center gap-2 mb-1">
													<p className="font-medium text-sm truncate">{profile.full_name || "Unknown User"}</p>
						...
						{query.length < 2 && !loading && (
							<div className="text-center py-12">
								...
								<p className="text-sm text-muted-foreground/70 mt-1">Search by name, profession, or skills</p>
							</div>
						)}
					</div>
				</div>
