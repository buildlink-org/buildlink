...
const CompactSkillsSection = ({ profile, handleProfileUpdate }: CompactSkillsSectionProps) => {
						...
						<div className="flex flex-wrap gap-2">
							{skills.map((skill, idx) => (
								<Badge
									key={idx}
									variant="secondary"
									className="bg-primary/10 px-3 py-1 text-sm text-primary transition-colors hover:bg-primary/20">
									{skill.name}
								</Badge>
							))}
						</div>
