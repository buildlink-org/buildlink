...
/** Downloads a file directly via blob fetch to bypass cross-origin browser restriction on <a> download attribute. */
export const downloadFile = async (url: string, fileName?: string): Promise<void> => {
	try {
		...
		link.href = blobUrl
		link.download = fileName || getFilenameFromUrl(url) || "document.pdf"
